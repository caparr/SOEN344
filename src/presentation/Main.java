...
public class Main {
	...
	public static void bookTickets() {
		...
		t[2] = new Ticket("Judy", "Star", Catalog.getInstance().search(1), 1);
		t[3] = new Ticket("June", "Hunter", Catalog.getInstance().search(1), 2);
		t[4] = new Ticket("Roger", "Federer", Catalog.getInstance().search(2), 4);
		t[5] = new Ticket("Maria", "Sharapova", Catalog.getInstance().search(2), 7);
		t[6] = new Ticket("Josh", "Hum", Catalog.getInstance().search(2), 8);
		t[7] = new Ticket("Cool", "Dude", Catalog.getInstance().search(2), 1);
		t[8] = new Ticket("Sweet", "Lady", Catalog.getInstance().search(3), 11);
		t[9] = new Ticket("Katniss", "Everdeen", Catalog.getInstance().search(3), 2);
		t[10] = new Ticket("Harry", "Potter", Catalog.getInstance().search(3), 4);
		t[11] = new Ticket("Ron", "Weasley", Catalog.getInstance().search(3), 3);
		t[12] = new Ticket("Captain", "Teemo", Catalog.getInstance().search(4), 5);
		t[13] = new Ticket("Monkey D", "Luffy", Catalog.getInstance().search(4), 1);		
		t[14] = new Ticket("Ichigo", "Kurosaki", Catalog.getInstance().search(4), 6);
